...
public class AMaasFileReaderTest {
    ...
    public void testAMaasFileReaderFileNotFound() {
        ...
        try {
            new AMaasFileReader(fileName, true);
            fail();
    ...
    public void testReadBytes() {
        try {
            AMaasFileReader fileReader = new AMaasFileReader(DataFileCreator.TEST_DATA_FILE_NAME, true);
    ...
    public void testFileHashes() {
        try {
            ...
            AMaasReader bufReader = new AMaasFileReader(path + "/" + fileName, true);
